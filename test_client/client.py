...
def send_request(model,slo,bs):
    ...
    result = requests.post(url, json={"image0": base64.b64encode(open("image.jpeg", "rb").read()).decode('utf-8'),
                                        "image1": base64.b64encode(open("dog.jpg", "rb").read()).decode('utf-8'),
                                        "image2": base64.b64encode(open("horses.jpg", "rb").read()).decode('utf-8'),
                                        "image3": base64.b64encode(open("both.png", "rb").read()).decode('utf-8'),
